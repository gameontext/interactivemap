 ...
 */
public class Log {
    private final static Logger log = Logger.getLogger("net.wasdev.gameon.interactivemap");
    private final static Logger detailLog = Logger.getLogger("interactivemap.details");
